...
async function main() {
  ...
  switch (command) {
    ...
    default: {
      ...
      console.log("");
      console.log(
        "🔧 deno run --allow-net --allow-read --allow-env db/init.ts migrate   - Run pending migrations",
      );
      console.log(
        "📊 deno run --allow-net --allow-read --allow-env db/init.ts status    - Check migration status",
      );
      console.log(
        "↩️  deno run --allow-net --allow-read --allow-env db/init.ts rollback  - Rollback info",
      );
      console.log("");
      console.log(
