...
export class BranchingRuleRepository {
   ...
   * Supports submodule_ids and module_ids
   */
  private async evaluateAllComplete(
    ...
    if (
      ...
      console.warn(
        "all_complete condition missing submodule_ids or module_ids",
      );
      return false;
    }
  ...
  private async evaluateAnyComplete(
    ...
    if (
      ...
      console.warn(
        "any_complete condition missing submodule_ids or module_ids",
      );
      return false;
    }
