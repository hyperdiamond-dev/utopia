...
describe("Module Routes", () => {
  ...
  describe("GET /modules (authenticated)", () => {
    ...
    it("should return module overview for authenticated user", async () => {
      ...
      stub(
        ModuleService,
        "getNavigationState",
        () => Promise.resolve(navState),
      );
      stub(
        ModuleService,
        "getUserProgress",
        () => Promise.resolve(progressStats),
      );
  ...
  describe("GET /modules/current", () => {
    it("should return current module for user", async () => {
      ...
      const res = await makeRequest(app, "GET", "/modules/current", {
        token: validToken,
      });
  ...
  describe("GET /modules/:moduleName", () => {
    it("should return module data for accessible module", async () => {
      ...
      const res = await makeRequest(app, "GET", "/modules/module-1", {
        token: validToken,
      });
    ...
    it("should return 403 when module is not accessible", async () => {
      ...
      const res = await makeRequest(app, "GET", "/modules/module-2", {
        token: validToken,
      });
  ...
  describe("POST /modules/:moduleName/start", () => {
    it("should start an accessible module", async () => {
      ...
      const res = await makeRequest(app, "POST", "/modules/module-1/start", {
        token: validToken,
      });
    ...
    it("should return 403 for completed module", async () => {
      ...
      const res = await makeRequest(app, "POST", "/modules/consent/start", {
        token: validToken,
      });
  ...
  describe("POST /modules/:moduleName/complete", () => {
    it("should complete module with valid submission", async () => {
      ...
      stub(
        ModuleService,
        "getModuleForUser",
        () => Promise.resolve(moduleDataInProgress),
      );
      stub(
        ModuleService,
        "completeModule",
  ...
  describe("GET /modules/:moduleName/responses", () => {
    it("should return responses for completed module", async () => {
      ...
      const res = await makeRequest(app, "GET", "/modules/consent/responses", {
        token: validToken,
      });
    ...
    it("should return null responses when none exist", async () => {
      ...
      const res = await makeRequest(app, "GET", "/modules/module-1/responses", {
        token: validToken,
      });
  ...
  describe("GET /modules/progress/stats", () => {
    it("should return detailed progress statistics", async () => {
      ...
      const res = await makeRequest(app, "GET", "/modules/progress/stats", {
        token: validToken,
      });
